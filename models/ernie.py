...
from transformers.models.ernie.modeling_ernie import ErnieOnlyMLMHead

from utils import bert_forward


class ErnieForChID(ErnieForMaskedLM):
    ...
    def forward(
        ...
        return bert_forward(self.ernie, self.cls, input_ids, attention_mask, token_type_ids, position_ids, head_mask,
